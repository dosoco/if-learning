...
describe('instructorHeight', () => {
  it(`should return 62 if given the string 'Jason'`, () => {
    expect(instructorHeight('Jason')).toBe(75)
  })

  it(`should return 69 if given the string 'Kyle'`, () => {
    expect(instructorHeight('Kyle')).toBe(69)
  })
