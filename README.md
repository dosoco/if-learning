...
* Write a function called `instructorHeight` that returns the height of your instructors, in inches. If given the string "Jason" it should return the number `62`. If given the string "Kyle", it should return the number `69`. If given anything else, it should return the string "I don't know that instructor!".
